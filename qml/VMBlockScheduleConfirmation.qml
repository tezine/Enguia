...
Rectangle {
	id:topWindow
	property var eConfirmation:enguia.createEntity("EScheduleConfirmation");
    ...
    ColumnLayout{
		...
		Label{
			...
			text:enguia.tr("Warning: If you confirm the appointment, the place will receive your Enguia profile (name, address, phone...).")
			Layout.fillWidth: true
			color: labelColor
			wrapMode: Text.Wrap
		}
	...
	function confirmAppointment(){
		mSVC.metaInvoke(MSDefines.SPlaceSchedules,"ConfirmAppointment",function(ok){
	...
	Component.onCompleted: {
		...
		mSAgenda.getScheduleConfirmation(mShared.placeID,serviceID,dt,tm,function(eScheduleConfirmation){

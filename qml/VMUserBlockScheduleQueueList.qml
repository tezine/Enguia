...
Item{
	...
	signal listItemPressAndHold(int id, string name, int userID, int serviceID, date dt)
...
//				}
			...
			MouseArea{
				...
				onPressAndHold: listItemPressAndHold(model.id, model.name, model.userID, model.serviceID, model.dt)
			}
	...
	function append(eUserScheduleQueue) {
		menuModel.append({dt:eUserScheduleQueue.dt1, id:eUserScheduleQueue.id, serviceName:eUserScheduleQueue.serviceName, name:eUserScheduleQueue.clientName, comment:eUserScheduleQueue.comment, userID:eUserScheduleQueue.clientUserID, serviceID:eUserScheduleQueue.serviceID, backColor:"transparent", showDelete:false, mobilePhone:eUserScheduleQueue.clientPhone})
		if(enguia.isValidDate(eUserScheduleQueue.dt2))menuModel.append({dt:eUserScheduleQueue.dt2, id:eUserScheduleQueue.id, serviceName:eUserScheduleQueue.serviceName,name:eUserScheduleQueue.clientName, comment:eUserScheduleQueue.comment, userID:eUserScheduleQueue.clientUserID, serviceID:eUserScheduleQueue.serviceID, backColor:"transparent", showDelete:false,mobilePhone:eUserScheduleQueue.clientPhone})
		if(enguia.isValidDate(eUserScheduleQueue.dt3))menuModel.append({dt:eUserScheduleQueue.dt3, id:eUserScheduleQueue.id, serviceName:eUserScheduleQueue.serviceName,name:eUserScheduleQueue.clientName, comment:eUserScheduleQueue.comment, userID:eUserScheduleQueue.clientUserID, serviceID:eUserScheduleQueue.serviceID, backColor:"transparent", showDelete:false,mobilePhone:eUserScheduleQueue.clientPhone})
		if(enguia.isValidDate(eUserScheduleQueue.dt4))menuModel.append({dt:eUserScheduleQueue.dt4, id:eUserScheduleQueue.id, serviceName:eUserScheduleQueue.serviceName,name:eUserScheduleQueue.clientName, comment:eUserScheduleQueue.comment, userID:eUserScheduleQueue.clientUserID, serviceID:eUserScheduleQueue.serviceID, backColor:"transparent", showDelete:false,mobilePhone:eUserScheduleQueue.clientPhone})
		if(enguia.isValidDate(eUserScheduleQueue.dt5))menuModel.append({dt:eUserScheduleQueue.dt5, id:eUserScheduleQueue.id, serviceName:eUserScheduleQueue.serviceName,name:eUserScheduleQueue.clientName, comment:eUserScheduleQueue.comment, userID:eUserScheduleQueue.clientUserID, serviceID:eUserScheduleQueue.serviceID, backColor:"transparent", showDelete:false,mobilePhone:eUserScheduleQueue.clientPhone})
	}
	function remove(id){
		for(var i=0;i<menuModel.count;i++) {
			if(menuModel.get(i).id===id) {

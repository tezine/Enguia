...
Rectangle {
	...
	function generateReport(){
		...
		mSVC.metaInvoke(MSDefines.SReports,"GetGraphicServiceReportForProfessional",function(list){
		...
		},mShared.placeID,professionalID,btnStart.dt,btnEnd.dt,comboService.getSelected());
	}
